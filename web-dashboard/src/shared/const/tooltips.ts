export const TOOLTIP_HINTS: Record<string, string> = {
    ...
    use_premium_discount_filter: "Allow longs only below the 4H equilibrium and shorts only above it.",
    use_space_to_target_filter: "Reject entries when there is not enough room to the opposite 4H swing for the minimum RR.",
    space_to_target_min_rr: "Minimum available R-multiple required before the opposite 4H swing blocks the trade.",
    use_choch_displacement_filter: "Require the 1H CHoCH break candle to have a strong body relative to ATR.",
