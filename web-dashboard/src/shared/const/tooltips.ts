export const TOOLTIP_HINTS: Record<string, string> = {
    ...
    poi_zone_upper_atr_mult: "POI ATR multiplier. The UI keeps upper and lower POI widths in sync with this value.",
    poi_zone_lower_atr_mult: "Hidden paired POI ATR multiplier. The UI keeps this synchronized with the visible POI control.",
